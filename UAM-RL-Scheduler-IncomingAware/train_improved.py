"""
train_improved.py - 训练新PPO（20维，七选一）
"""
...
def train_improved(
    ...
    print("训练完成！")
    print("=" * 80)
    print(f"\n测试命令: python test_improved.py --model {final_model_path}")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_path', type=str, default='models/improved_ppo')
